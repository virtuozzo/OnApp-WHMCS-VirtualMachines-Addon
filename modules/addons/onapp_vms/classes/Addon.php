...
require_once dirname( dirname( dirname( dirname( __FILE__ ) ) ) ) . '/servers/onapp/lib.php';
...
class OnApp_VMs_Addon {
	...
	private function getOnAppObject( $class, $server_ip, $username = null, $apikey = null ) {
		$required_path = dirname( dirname( dirname( dirname( __FILE__ ) ) ) ) . '/servers/onapp/wrapper/';
	...
	private function get_service1($service_id) {
